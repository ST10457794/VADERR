...
const services = [
  {
    ...
    description:
      "Comprehensive electrical services including DB maintenance, testing & commissioning, panel wiring, automation, and fault repairs."
  },
  {
    icon: "Zap",
    title: "Pump & Motor Supply",
    description:
      "Reliable supply of slurry pumps, submersible pumps, motors, transformers, switchgear, VSDs, soft starters, and related spares."
  },
  {
    icon: "Wrench",
    title: "Repair & Reconditioning",
    description:
      "Specialised repair services for pumps, motors, gearboxes, and bearings to extend equipment lifespan and efficiency."
  },
  {
    icon: "Truck",
    title: "Plant Hire",
    description:
      "Flexible plant hire solutions including loaders, excavators, tipper trucks, water bowsers, and dewatering pumps."
  }
];
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="text-center mb-20 animate-slide-up">
          ...
          <p className="font-lato text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Comprehensive engineering and industrial services designed to meet
            the most complex sector needs with precision, reliability, and
            innovation.
          </p>
        </div>
